  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        setLoginError('');
        navigate('/doctorprofile'); // Replace '/doctor' with the actual path of your doctor page
      ...
      <div className="login-container">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input type="text" id="userId" name="staffId" placeholder="staff ID" value={staffId} onChange={handleChange} />
          </div>
          <div className="form-group">
        ...
        <Link to="/docregister" className="register-link">Register here</Link>
      </div>
    </div>
  );
};
